...
<script>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            ...
            desc: '尽一份微薄之力，助力母校腾飞！',
            link: '${applicationScope.globalUrlPrefix}/wechat/hitef/donate/certification/${out_trade_no}',
            imgUrl: '${applicationScope.globalUrlPrefix}/wechat/hitef/certifications/${out_trade_no}.jpg',
        });
        //分享到微信朋友圈
